...
export default function ContactClient({ contacts }: Props) {
  ...
  const address = contacts.contact_address || '75001 Paris, France'
  const phone   = contacts.contact_phone   || '+33 (0)1 45 67 89 00'
  const email   = contacts.contact_email   || 'contact@lartdelatable.fr'
      ...
      <header className="contact-hero container">
        <div className="contact-hero__grid">
          ...
          <div className="contact-hero__desc">
            <p>
              Un projet de restauration, un événement privé ou une sélection sur-mesure ?
              Nos experts vous accompagnent dans chaque détail.
            </p>
          </div>
        </div>
      </header>
          ...
          <aside className="contact-sidebar">
              ...
              <div className="info-list">
                ...
                <div className="info-item">
                  ...
                  <div>
                    ...
                    <a href={`tel:${phone.replace(/\s/g, '')}`} className="text-medium">{phone}</a>
                  </div>
                </div>
                {address && (
                  <div className="info-item">
                    ...
                    <div>
                      <p className="label-sm text-muted">Adresse</p>
            ...
            <div className="decorative-image">
              ...
              <div className="image-quote glassmorphism">
                <p className="headline-sm italic m-0">
                  "Le détail est ce qui fait la différence entre le bon et le sublime."
                </p>
              </div>
            </div>
          </aside>
              ...
              <>
                ...
                <form className="atelier-form" onSubmit={handleSubmit}>
                  <div className="form-group">
                    ...
                    <input type="text" id="last-name" placeholder="Duchamp" required
                      value={form.lastName} onChange={e => set('lastName', e.target.value)} />
                  </div>
                  <div className="form-group">
                    <label htmlFor="first-name" className="label-md">Prénom *</label>
                    <input type="text" id="first-name" placeholder="Alexandre" required
                      value={form.firstName} onChange={e => set('firstName', e.target.value)} />
                  </div>
                  <div className="form-group full-width">
                    <label htmlFor="company" className="label-md">Établissement / Entreprise</label>
                    <input type="text" id="company" placeholder="Hôtel de Paris Monte-Carlo"
                      value={form.company} onChange={e => set('company', e.target.value)} />
                  </div>
                  <div className="form-group">
                    <label htmlFor="email" className="label-md">Email *</label>
                    <input type="email" id="email" placeholder="alexandre@domaine.fr" required
                  ...
                  <div className="form-group full-width">
                    ...
                    <div className="select-wrapper">
                      <select id="needs" value={form.need} onChange={e => set('need', e.target.value)}>
                        {NEEDS.map(n => (
                  ...
                  <div className="form-group full-width">
                    ...
                    <textarea id="message" rows={4} placeholder="Décrivez votre vision…"
